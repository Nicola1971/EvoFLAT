...
<head>
    ...
    preferredFormat: "hex3",
        ...
        //main color
        var mainColour = " ";
    if(localStorage.getItem("EvoMainColour")){
      mainColour = localStorage.getItem("EvoMainColour");
    }
    $("#treeRoot a:not(.deleted):not(.unpublished):not(.hidemenu) .title").css({color:mainColour});
    $("h1 i.fa").css({color:mainColour});
    $(".treeframebody .tab-row h2.tab span i").css({color:mainColour});
    $("form").on("submit", function(ev){
    ev.preventDefault();
    var newMColour =$("#mainpicker").spectrum("get");
    localStorage.setItem("EvoMainColour",newMColour);
    $("#colPicked4").html(newMColour);
    $("#treeRoot a:not(.deleted):not(.unpublished):not(.hidemenu) .title").css({color:newMColour});
    $("h1 i.fa").css({color:mainColour});
    $(".treeframebody .tab-row h2.tab span i").css({color:newMColour});
    location.reload();
    });
    $("#mainpicker").spectrum({
    flat: true,
    ...
    preferredFormat: "hex3",
        ...
        color: localStorage.getItem("EvoMainColour")
        });
         //text color
            var txColour = " ";
                       ...
                       <li class="dropdown newresource">
                        ...
                        <li class="dropdown menupicker">
                          <a href="javascript:;" class="dropdown-toggle" onclick="return false;"><i class="fa fa-paint-brush"></i></a>
                            ...
                            <li class="item-group"><a style="cursor:default;" href="javascript:;"><i class="fa fa-paint-brush"></i> Main Color<span id="colPicked4"></span></a>
                            <a title="<?= $_lang['reset'] ?>" href="javascript:;" onclick="cleanLocalStorage('EvoMainColour')" class="resetcolor btn btn-secondary"><i class="fa fa-refresh"></i></a></li>
                              <li><form method="" action="">
                                <input type="text" value='#0275d8' id="mainpicker" name="EvoMainColour"/> <br/>  </form>
                              </li>
                            ...
                            <a title="<?= $_lang['reset'] ?>" href="javascript:;" onclick="cleanLocalStorage('EvoMenuTextColour')" class="resetcolor btn btn-secondary"><i class="fa fa-refresh"></i></a></li>
                              <li><form method="" action="">
                                <input type="text" value='#bbb' id="textpicker" name="EvoMenuTextColour"/> <br/>  </form>
                              </li>
                            ...
                            <a title="<?= $_lang['reset'] ?>" href="javascript:;" onclick="cleanLocalStorage('EvoMenuTextHColour')" class="resetcolor btn btn-secondary"><i class="fa fa-refresh"></i></a></li>
                              <li><form method="" action="">
                                <input type="text" value='#f3f3f3' id="textHpicker" name="EvoMenuTextHColour"/> <br/>               <input type="reset" onclick="cleanLocalStorage('EvoMenuColour,EvoMenuTextHColour,EvoMenuTextColour,EvoMainColour')" class="btn btn-secondary" value="<?= $_lang['reset'] ?>" style="margin-left:2.2rem;">
